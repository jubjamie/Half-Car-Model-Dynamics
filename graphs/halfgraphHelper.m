...
f11=figure(11);
plot(Displacements.Body_Displacement.Time,Displacements.Body_Displacement.Data,'b-','LineWidth',1.2);
...
%% Car Velocity
f12=figure(12);
plot(Displacements.Body_Velocity.Time,Displacements.Body_Velocity.Data,'r-','LineWidth',1.2);
...
%% Wheel Displacements
f13=figure(13);
plot(Wheels_Data.Front_Wheel_Displacement.Time,Wheels_Data.Front_Wheel_Displacement.Data,'b-','LineWidth',1.2);
hold on;
plot(Wheels_Data.Rear_Wheel_Displacement.Time,Wheels_Data.Rear_Wheel_Displacement.Data,'b--','LineWidth',1);
...
%% Wheel Velocity
f14=figure(14);
plot(Wheels_Data.Front_Wheel_Velocity.Time,Wheels_Data.Front_Wheel_Velocity.Data,'r-','LineWidth',1.2);
hold on;
plot(Wheels_Data.Rear_Wheel_Velocity.Time,Wheels_Data.Rear_Wheel_Velocity.Data,'r--','LineWidth',1);
